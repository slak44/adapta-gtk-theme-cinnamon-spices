...
mkdir "$BUILDDIR/Adapta/gtk-3.20";
...
cp "$WORKDIR/gtk/gtk-3.20/gtk-contained.css" "$BUILDDIR/Adapta/gtk-3.20/gtk.css";
ln -sr "$BUILDDIR/Adapta/assets" "$BUILDDIR/Adapta/gtk-3.20/assets";
ln -sr "$BUILDDIR/Adapta/assets/thumbnail.png" "$BUILDDIR/Adapta/gtk-3.20/thumbnail.png";
...
mkdir "$BUILDDIR/Adapta-Nokto/gtk-3.20";
...
cp "$WORKDIR/gtk/gtk-3.20/gtk-contained-dark.css" "$BUILDDIR/Adapta-Nokto/gtk-3.20/gtk.css";
ln -sr "$BUILDDIR/Adapta-Nokto/assets" "$BUILDDIR/Adapta-Nokto/gtk-3.20/assets";
ln -sr "$BUILDDIR/Adapta-Nokto/assets/thumbnail-dark.png" "$BUILDDIR/Adapta-Nokto/gtk-3.20/thumbnail.png";
...
mkdir "$BUILDDIR/Adapta-Eta/gtk-3.20";
...
cp "$WORKDIR/gtk/gtk-3.20-eta/gtk-contained.css" "$BUILDDIR/Adapta-Eta/gtk-3.20/gtk.css";
ln -sr "$BUILDDIR/Adapta-Eta/assets" "$BUILDDIR/Adapta-Eta/gtk-3.20/assets";
ln -sr "$BUILDDIR/Adapta-Eta/assets/thumbnail.png" "$BUILDDIR/Adapta-Eta/gtk-3.20/thumbnail.png";
...
mkdir "$BUILDDIR/Adapta-Nokto-Eta/gtk-3.20";
...
cp "$WORKDIR/gtk/gtk-3.20-eta/gtk-contained-dark.css" "$BUILDDIR/Adapta-Nokto-Eta/gtk-3.20/gtk.css";
ln -sr "$BUILDDIR/Adapta-Nokto-Eta/assets" "$BUILDDIR/Adapta-Nokto-Eta/gtk-3.20/assets";
ln -sr "$BUILDDIR/Adapta-Nokto-Eta/assets/thumbnail-dark.png" "$BUILDDIR/Adapta-Nokto-Eta/gtk-3.20/thumbnail.png";
