...
ln -sr "$BUILDDIR/Adapta/assets/thumbnail.png" "$BUILDDIR/Adapta/gtk-4.0/thumbnail.png"
...
mkdir "$BUILDDIR/Adapta-Nokto/gtk-4.0"
...
ln -sr "$BUILDDIR/Adapta-Nokto/assets/thumbnail-dark.png" "$BUILDDIR/Adapta-Nokto/gtk-4.0/thumbnail.png"
