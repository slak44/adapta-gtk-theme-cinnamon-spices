...
# Adapta
mkdir -p "$BUILDDIR/Adapta"
mkdir -p "$BUILDDIR/Adapta/gtk-2.0"
mkdir -p "$BUILDDIR/Adapta/gtk-3.0"
mkdir -p "$BUILDDIR/Adapta/gtk-3.22"
mkdir -p "$BUILDDIR/Adapta/gtk-4.0"
mkdir -p "$BUILDDIR/Adapta/scripts"
rsync -a -u "$WORKDIR/shell/cinnamon"/ "$BUILDDIR/Adapta/cinnamon"
ln -srfn "$BUILDDIR/Adapta/cinnamon/assets/thumbnail.png" "$BUILDDIR/Adapta/cinnamon/thumbnail.png"
...
ln -srfn "$BUILDDIR/Adapta/assets" "$BUILDDIR/Adapta/gtk-3.0/assets"
ln -srfn "$BUILDDIR/Adapta/assets/thumbnail.png" "$BUILDDIR/Adapta/gtk-3.0/thumbnail.png"
...
# Adapta-Nokto
mkdir -p "$BUILDDIR/Adapta-Nokto"
mkdir -p "$BUILDDIR/Adapta-Nokto/gtk-2.0"
mkdir -p "$BUILDDIR/Adapta-Nokto/gtk-3.0"
mkdir -p "$BUILDDIR/Adapta-Nokto/gtk-3.22"
mkdir -p "$BUILDDIR/Adapta-Nokto/gtk-4.0"
mkdir -p "$BUILDDIR/Adapta-Nokto/scripts"
rsync -a -u "$WORKDIR/shell/cinnamon-nokto"/ "$BUILDDIR/Adapta-Nokto/cinnamon"
ln -srfn "$BUILDDIR/Adapta-Nokto/cinnamon/assets/thumbnail.png" "$BUILDDIR/Adapta-Nokto/cinnamon/thumbnail.png"
...
ln -srfn "$BUILDDIR/Adapta-Nokto/assets" "$BUILDDIR/Adapta-Nokto/gtk-3.0/assets"
ln -srfn "$BUILDDIR/Adapta-Nokto/assets/thumbnail-dark.png" "$BUILDDIR/Adapta-Nokto/gtk-3.0/thumbnail.png"
