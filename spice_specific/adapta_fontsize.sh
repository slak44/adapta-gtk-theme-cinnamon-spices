...
SYSTEMFONT="stage { color: #COLOR; font-weight: 400; }";
SYSTEMFONTDESC="System controlled";
SMALLFONT="stage { font-size: 8pt; color: #COLOR; font-family: Roboto, Sans-Serif; font-weight: 400; }";
SMALLFONTDESC="Small font size (8pt)"
STANDARDFONT="stage { font-size: 10pt; color: #COLOR; font-family: Roboto, Sans-Serif; font-weight: 400; }";
STANDARDFONTDESC="Standard font size (10pt)"
LARGEFONT="stage { font-size: 12pt; color: #COLOR; font-family: Roboto, Sans-Serif; font-weight: 400; }";
LARGEFONTDESC="Large font size (12pt)"
VLARGEFONT="stage { font-size: 14pt; color: #COLOR; font-family: Roboto, Sans-Serif; font-weight: 400; }";
VLARGEFONTDESC="Very large font size (14pt)"
LARGESTFONT="stage { font-size: 16pt; color: #COLOR; font-family: Roboto, Sans-Serif; font-weight: 400; }";
